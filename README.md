...
## Environments
- Preview: https://main--aem-WYSIWYG--swajayab.aem.page/
- Live: https://main--aem-WYSIWYG--swajayab.aem.live/
...
1. Open the `aem-WYSIWYG` directory in your favorite IDE and start coding :)
